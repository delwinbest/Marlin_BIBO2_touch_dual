...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 400, 400, 1600, 385.63 } // 1/32 microstepping
...
#define X_MIN_POS 0    
#define Y_MIN_POS 0     // Additional fan scrapes the front cover, reducing to accmodate
#define Z_MIN_POS 0
